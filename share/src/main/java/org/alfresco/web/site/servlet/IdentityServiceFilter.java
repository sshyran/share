...
import org.alfresco.web.site.FilterConfigUtils;
...
public class IdentityServiceFilter extends KeycloakOIDCFilter  {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        FilterConfigUtils filterConfigUtils = (FilterConfigUtils) context.getBean("filterConfigUtils");

        this.enabled = filterConfigUtils.isIdentityServiceEnabled();
