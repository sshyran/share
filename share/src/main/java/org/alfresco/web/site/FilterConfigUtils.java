...
public class FilterConfigUtils implements ApplicationContextAware {
    ...
    public boolean isIdentityServiceEnabled() {
        IdentityServiceConfigElement config = (IdentityServiceConfigElement) this.configService.getConfig("IdentityService")
